...
async function crossReference() {
    try {
        ...
        console.log(`Checking ${pendingUpdates.length} pending updates against Supermart data...\n`);
        ...
        for (const update of pendingUpdates) {
            ...
            if (match) {
                console.log(`MATCH FOUND for Update ${update._id}:`);
                ...
                console.log(`- Store: ${product.storeLocation}`);
                console.log('---');
            }
        }
