...
async function checkQueueForNameMatch() {
    try {
        ...
        console.log(`Checking ${pendingUpdates.length} pending updates for name matches with Supermart...\n`);
        ...
        for (const update of pendingUpdates) {
            ...
            if (match) {
                console.log(`NAME MATCH FOUND for Update ${update._id}:`);
                console.log(`- DB Product: ${product.name}`);
                console.log(`- Supermart Match: ${match.name}`);
                console.log(`- Proposed Price: ₦${update.price}`);
                console.log(`- Supermart Price: ₦${match.price}`);
                console.log('---');
            }
        }
