    ...
    return (
        <div className="z-50">
            ...
            <header className="sticky top-0 z-50 w-full glass border-b border-primary/10 transition-all duration-500">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-20 flex items-center justify-between gap-4">
                    ...
                    <div className="sm:hidden flex items-center gap-3">
                        {user ? (
                            <Link href="/profile" className="w-9 h-9 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary shadow-premium-sm">
                                <CircleUser size={20} />
                            </Link>
                        ) : (
            ...
            <nav className="sm:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-sm bg-slate-950/90 backdrop-blur-3xl border border-white/10 px-4 py-3 flex justify-between items-center z-[100] shadow-[0_20px_50px_rgba(0,0,0,0.5)] rounded-[2.5rem] ring-1 ring-white/5">
                <Link href="/" className={`flex flex-col items-center gap-1.5 transition-all duration-500 ${pathname === '/' ? 'text-primary scale-110 -translate-y-0.5' : 'text-slate-500 hover:text-slate-300'}`}>
                ...
                <Link href="/leaderboard" className={`flex flex-col items-center gap-1.5 transition-all duration-500 ${pathname === '/leaderboard' ? 'text-primary scale-110 -translate-y-0.5' : 'text-slate-500 hover:text-slate-300'}`}>
                ...
                <Link href="/stale-prices" className={`flex flex-col items-center gap-1.5 transition-all duration-500 -translate-y-3`}>
                ...
                <Link href="/forum" className={`flex flex-col items-center gap-1.5 transition-all duration-500 ${pathname === '/forum' ? 'text-primary scale-110 -translate-y-0.5' : 'text-slate-500 hover:text-slate-300'}`}>
                ...
                <Link href="/profile" className={`flex flex-col items-center gap-1.5 transition-all duration-500 ${pathname === '/profile' ? 'text-primary scale-110 -translate-y-0.5' : 'text-slate-500 hover:text-slate-300'}`}>
